...
public class Replication_Auto {
    ...
    private final String xCode = "0";
    private final DatabaseHelper dbh;
    NotificationManager notificationManager;
    String url;
    Cursor cursor;

    public Replication_Auto(Context mContext) {
    ...
    public void replicate_all() {
        Log.e("bklog_autoQuery_rep", "start");
        noti_Messaging("بروز رسانی خودکار", "در حال دریافت اطلاعات");
    ...
    public void replicateGoodChange() {
        ...
        StringRequest stringrequste = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                            ...
                            switch (state) {
                                ...
                                default:
                                    for (int i = 0; i < il; i++) {
                                        ...
                                        Log.e("bklog_autoQuery", qCol.toString());
            ...
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Log.e("bklog_volleyError", volleyError + "");
                volleyError.printStackTrace();
            }
        }) {
            @Override
...
//                                        qCol = "INSERT OR REPLACE INTO Good( GoodCode " + qCol + ") VALUES(" + code + qVal + ")";
                        ...
                        if (il >= RepRowCount) {
                            ...
                            Log.e("bklog_autoQuery_rep", "Done");
                        }
                    }
                }.start();
            }
